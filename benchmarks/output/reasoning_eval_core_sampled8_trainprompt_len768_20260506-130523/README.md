...
```bash
scripts/evaluate_reasoning_vllm.py --models-config configs/models.gsmplus_actual.yaml --models base,sent_best,sent_final,no_sent_final --datasets gsm8k,gsm-plus,math500,aime24 --tier maximal --output-dir benchmarks/output/reasoning_eval_core_sampled8_trainprompt_len768_20260506-130523 --protocol sampled --n-samples 8 --max-new-tokens 768 --prompt-style training --limit-per-dataset 100 --gpu-memory-utilization 0.90 --max-num-seqs 8 --max-num-batched-tokens 8192 --batch-size 8 --seed 46
```
